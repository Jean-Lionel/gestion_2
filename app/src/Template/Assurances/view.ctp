...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Modifier Assurance'), ['action' => 'edit', $assurance->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Supprimer Assurance'), ['action' => 'delete', $assurance->id], ['confirm' => __('Are you sure you want to delete # {0}?', $assurance->id)]) ?> </li>
