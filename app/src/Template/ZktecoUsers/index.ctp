...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        <li class="heading"><?= __('Actions') ?></li>
         <li><?= $this->Html->link(__('Rapport des présence'), ['controller'=>'ZktecoPresance','action' => 'index']) ?></li> 
    </ul>
</nav>
<div class="zktecoUsers index large-9 medium-8 columns content">
    <h3><?= __('Les emprientes digital qui sont enregisté') ?></h3>
    <table cellpadding="0" cellspacing="0">
            ...
            <tr>
             <!--    <th scope="col"><?= $this->Paginator->sort('id') ?></th>
                ...
                <th scope="col"><?= $this->Paginator->sort('name') ?></th>
                 <th scope="col"><?= $this->Paginator->sort('id_number','Numéro') ?>
        ...
        <tbody>
            ...
            <tr>
              ...
              <!--   <td class="actions">
                    <?= $this->Html->link(__('Affiche'), ['action' => 'view', $zktecoUser->id]) ?>
                    <?= $this->Html->link(__('Modifier'), ['action' => 'edit', $zktecoUser->id]) ?>
                    <?= $this->Form->postLink(__('Supprimer'), ['action' => 'delete', $zktecoUser->id], ['confirm' => __('Are you sure you want to delete # {0}?', $zktecoUser->id)]) ?>
                </td> -->
            </tr>
            <?php endforeach; ?>
        </tbody>
