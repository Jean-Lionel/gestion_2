...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(__('Supprimer Category'), ['action' => 'delete', $category->id], ['confirm' => __('Are you sure you want to delete # {0}?', $category->id)]) ?> </li>
        <li><?= $this->Html->link(__('Listes des Categories'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('Nouvel Category'), ['action' => 'add']) ?> </li>
